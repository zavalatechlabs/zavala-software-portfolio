                ...
                <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  {demo && (
                    <a
                      ...
                      className="text-zavala-text-tertiary hover:text-zavala-accent-secondary transition-colors"
                      title="Live Demo"
                    >
                  ...
                  {github && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="text-zavala-text-tertiary hover:text-zavala-text-primary transition-colors"
