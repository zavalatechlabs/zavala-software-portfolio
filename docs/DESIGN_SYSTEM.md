...
**Reference:** See [`DESIGN_DIRECTION.md`](./DESIGN_DIRECTION.md) for design decisions, inspiration analysis, and feature priorities.
...
- **Design Direction:** [`DESIGN_DIRECTION.md`](./DESIGN_DIRECTION.md) — Full design decisions and inspiration
