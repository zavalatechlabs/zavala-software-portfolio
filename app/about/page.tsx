...
export const metadata: Metadata = {
  ...
  description: 'Resume - Maximiliano Zavala, Software Engineer | AI Enthusiast',
}
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        <h1 className="text-4xl md:text-5xl font-bold mb-16 text-zavala-text-primary text-center">
          Maximiliano Zavala - Software Engineer | AI Enthusiast
        </h1>

        {/* Work Experience */}
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-8 text-zavala-text-primary flex items-center gap-2">
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-2 border-zavala-border pl-6 pb-8 last:pb-0">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                <h3 className="text-xl font-semibold text-zavala-text-primary">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            {/* Languages */}
            <div>
              <h3 className="text-sm font-semibold text-zavala-text-tertiary uppercase tracking-wide mb-3">
                Languages
              </h3>
              <div className="flex flex-wrap gap-2">
                {[
        ...
        <div className="text-center pt-8 border-t border-zavala-border">
          <h2 className="text-xl font-semibold mb-4 text-zavala-text-primary">
